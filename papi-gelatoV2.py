...
def stap1():
    ...
    if aantal <= 3:
        ...
        print(f"Dan krijgt u van mij een bakje met {aantal} bolletjes {taste} ijs")
        exit()
    elif aantal > 8:
        print("Sorry, zulke grote bakken hebben we niet")
        stap1()
    keuze = input(f"Hier is uw {stap2} met {aantal} bolletje(s) {taste} ijs. Wilt u nog meer bestellen? (Y/N)")
    if keuze == 'Y':
        stap1()
    elif keuze == 'N':
